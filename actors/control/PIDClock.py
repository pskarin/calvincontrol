...
class PIDClock(Actor):
    ...
    def init(self, td=1., ti=5., tr=10., kp=-.2, ki=0., kd=0., n=10., beta=1., period=0.05, max_q=1000, name="Name"):
    ...
    def calc_output(self):
        ...
        _log.warning("control output calculated: y_t {}, ref_t {}".format(y_t, ref_t))
       #_log.info(y_t, ref_t)
